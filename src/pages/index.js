...
const schema = {
  ...
  description:
    "¿Necesitas cambiar divisa en Santa Cruz? Visita nuestra casa de cambio y cambia moneda extranjera al momento y sin comisiones. Solo en Quickgold.",
  address: {
    "@type": "PostalAddress",
  ...
  return (
    <>
      <Head>
        ...
        ></script>
        <title>
          Casas de Cambio en Santa Cruz de Tenerife | Cambio de Divisas Santa
          Cruz
        </title>
        <meta
          name="description"
          content="¿Necesitas cambiar divisa en Santa Cruz? Visita nuestra casa de cambio y cambia moneda extranjera al momento y sin comisiones. Solo en Quickgold."
        />
